...
// Relative timestamp with zero new dependencies. Renders a deterministic
// absolute label during SSR + hydration and upgrades to the relative label once
// mounted on the client, avoiding an SSR/client hydration mismatch.
